...
def quant_act_uni(x , base , num_quant_levels):
  ...
  x_divided_rounded_clipped = tf.clip_by_value(x_divided_rounded , clip_value_min = tf.constant(0.0), clip_value_max = num_quant_levels - 1)
    ...
    with slim.arg_scope([slim.conv2d, slim.separable_conv2d], padding=padding):
      ...
      for i, conv_def in enumerate(conv_defs):
        ...
        if isinstance(conv_def, Conv):
          ...
          net = quant_act_uni(net, act_quant_delta[cnt_act_layer] , act_quant_levels[cnt_act_layer])
          cnt_act_layer += 1
...
def mobilenet_v1(inputs,
                 ...
                 scope='MobilenetV1',
                 global_pool=False,
                 wei_quant_lambda_input = [], wei_quant_delta_input = [], wei_quant_levels_input = [], act_quant_delta_input = [], act_quant_levels_input = []):
