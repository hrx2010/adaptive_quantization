...
id_quant_wei_layer = -1
cnt_quant_wei_layer = 0
wei_quant_lambda = 0.0
wei_quant_delta = 0.0
wei_quant_levels = -1


def weights_name_check(testing_name):
	if ("weights" in testing_name):	
		return 1
...
def quant_wei_uni_dead_zone(x):
	if(weights_name_check(x.name) == 1):
		global cnt_quant_wei_layer
		global id_quant_wei_layer
		global wei_quant_lambda
		global wei_quant_delta
		global wei_quant_levels
		print('the id of weights %d' % (cnt_quant_wei_layer))

		if cnt_quant_wei_layer >= 50:
			cnt_quant_wei_layer -= 50

		if cnt_quant_wei_layer != id_quant_wei_layer:
			cnt_quant_wei_layer += 1
			return x

		num_quant_levels = wei_quant_levels
		q_lambda = wei_quant_lambda
		q_delta = wei_quant_delta
...
def mobilenet_v1(inputs,
                 ...
                 scope='MobilenetV1',
                 global_pool=False, 
                 id_quant_wei_layer_input=-1,
                 wei_quant_lambda_input=-1,
                 wei_quant_delta_input=-1,
                 wei_quant_levels_input=-1):
  ...
  id_quant_wei_layer = id_quant_wei_layer_input
