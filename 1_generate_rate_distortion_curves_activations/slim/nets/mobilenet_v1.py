      ...
      for i, conv_def in enumerate(conv_defs):
        ...
        if isinstance(conv_def, Conv):
          ...
          net = slim.conv2d(net, depth(conv_def.depth), conv_def.kernel,
                            ...
                            scope=end_point)
          #quantization act
          if cnt_act_layer == id_act_layer:
            net = quant_act_uni(net, act_quant_delta, act_quant_levels)
          cnt_act_layer += 1
          if cnt_act_layer >= 27:
            cnt_act_layer = 0
...
def mobilenet_v1(inputs,
                 ...
                 scope='MobilenetV1',
                 global_pool=False,
                 id_act_layer_input=-1,
                 act_quant_delta_input=-1,
                 act_quant_levels_input=-1):
  ...
  id_act_layer = id_act_layer_input
