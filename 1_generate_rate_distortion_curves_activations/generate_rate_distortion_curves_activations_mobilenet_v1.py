...
SLIM_PATH = '/home/wangzhe/Documents/exp/exp_2019_4_p2/4_25_6_output_error_mobilenet_v1_act_test2/slim/'
...
act_codebook_path = '/home/wangzhe/Documents/exp/mobilenet_v1_data/codebooks_mobilenet_v1_activations_uni/'

layer_id = int(sys.argv[1])
quant_level = int(sys.argv[2])

dir_wei_codebooks = act_codebook_path + '/' + 'act_layer_' + str(layer_id) + '.dat_' + str(quant_level) + '.cb' 
quant_delta = load_codebook_act(dir_wei_codebooks)
...
with slim.arg_scope(mobilenet_v1.mobilenet_v1_arg_scope(
	...
	logits, _ = mobilenet_v1.mobilenet_v1(processed_images, is_training=False, depth_multiplier=1.0, num_classes=1001, id_act_layer_input=layer_id, act_quant_delta_input=quant_delta, act_quant_levels_input=quant_level)
...
print('output error %d %d: %f' % (layer_id , quant_level, output_error))
output_error_saved_path = 'results/output_error_' + str(layer_id) + '_' + str(quant_level)
